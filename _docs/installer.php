...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20201026_grupoellorh_d2343267fe9aaff92788_20201218131132_archive.zip';
	const ARCHIVE_SIZE		 = '747633425';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd234326-18131132';
    const SECONDARY_PACKAGE_HASH = 'd81d231-18131132';
