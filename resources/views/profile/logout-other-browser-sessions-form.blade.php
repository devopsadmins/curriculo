<x-jet-action-section>
    <x-slot name="title">
        {{ __('Outros Navegadores') }}
    </x-slot>

    <x-slot name="description">
        {{ __('Gerencia e efetue logoff de outras sessões ativos em outros dispositivos') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Se necessário, você pode efetuar logoff de outros dispositivos conectados.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Sair de outros dispositivos') }}
            </x-jet-button>
